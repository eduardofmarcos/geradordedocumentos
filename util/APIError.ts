...
export abstract class APIError extends Error {
    ...
    public getLocalizedMessage(language: { query: { locale: string } } | { locale: string } | string): string {
        
        const message: any = this.I18NMessage ? this.I18NMessage[I18N.getValidLocale(language)] : this.message;
