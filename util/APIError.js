...
exports.ValidationError = exports.TokenInvalid = exports.UserError = exports.AuditError = exports.TestimonyError = exports.APIError = void 0;
...
class APIError extends Error {
    ...
    getLocalizedMessage(language) {
        const message = this.I18NMessage ? this.I18NMessage[I18N_1.I18N.getValidLocale(language)] : this.message;
        return message;
    }
}
