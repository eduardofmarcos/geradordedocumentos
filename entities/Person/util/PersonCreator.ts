...
export class PersonCreator {
    ...
    private static async gerarPerson() {
        ...
        let randomDate = this.randomDate(new Date(1950, 0, 1), new Date(2002, 0, 1))
        let age = this.getAge(randomDate)
        
        
        let firstNames = ['Eduardo', 'Gilberto', 'Douglas', 'Helen', 'Sofia', 'Joana', 'Marcos', 'Pedro', 'Camila', 'Mateus', 'Isadora']
        ...
        let stateObj: any = {
            ...
            stateGroups2: ["Pará", "Amazonas", "Acre", "Amapá", "Rondônia", "Roraima"],
        ...
        const person: IPerson = {
            ...
            city: "CidadeTeste",
            state: stateObj["stateGroups" + cpfDigit][Math.floor(this.getRandomArbitrary(0, stateObj["stateGroups" + cpfDigit].length))],
